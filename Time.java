...
public final class Time implements Comparable<Time> {
	...
	//converts a period in ms to hours, minutes, and seconds 
	public static long[] convertHMS(long ms){
		long hours = ms/1000/60/60; 
		long mins = (ms - hours*1000*60*60)/1000/60; 
		long secs = (ms - hours*1000*60*60 - mins*1000*60)/1000;
		long[] converted = {hours, mins, secs}; 
		return converted; 
	}
