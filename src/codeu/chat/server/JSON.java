			...
			// very last } in the json file
			{
				...
				if (jp.getText().equals("conversations")) {
					...
					while (jp.nextToken() != JsonToken.END_ARRAY) {
						...
						if (!(title.equals("")) && id != null && owner != null && creation != null && last != null
								&& first != null) {
							model.add(new ConversationHeader(id, owner, creation, title),
									new ConversationPayload(id, first, last));
							title = "";
							id = null;
							owner = null;
							creation = null;
				...
				if (jp.getText().equals("messages")) {
					...
					while (jp.nextToken() != JsonToken.END_ARRAY) {
						...
						if (!(body.equals("")) && id != null && owner != null && creation != null && previous != null
								&& next != null) {
